    ...
    public function updateUserRole(Request $request, User $user){
        if($user){
            ...
            if($user_privilege){
                ...
                $user_privilege->reports_ppr = $request->reports_ppr;
                ...
                $new_user_privilege->reports_ppr = $request->reports_ppr;
                ...
                $new_user_privilege->payroll_period = isset($request->payroll_period) ? $request->payroll_period : null;
                $new_user_privilege->payroll_payreg = isset($request->payroll_payreg) ? $request->payroll_payreg : null;
                $new_user_privilege->payroll_payreg_post = isset($request->payroll_payreg_post) ? $request->payroll_payreg_post : null;
                $new_user_privilege->payroll_payreg_unpost = isset($request->payroll_payreg_unpost) ? $request->payroll_payreg_unpost : null;
                $new_user_privilege->payroll_attendance = isset($request->payroll_attendance) ? $request->payroll_attendance : null;
                $new_user_privilege->payroll_salary_adjustment = isset($request->payroll_salary_adjustment) ? $request->payroll_salary_adjustment : null;
                $new_user_privilege->payslip_filter_per_company = isset($request->payslip_filter_per_company) ? $request->payslip_filter_per_company : null;
                $new_user_privilege->payroll_contribution = isset($request->payroll_contribution) ? $request->payroll_contribution : null;
