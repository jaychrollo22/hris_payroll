<div class="modal fade" id="newSchedule" tabindex="-1" role="dialog" aria-labelledby="newScheduleLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form  method='POST' action='new-schedule' onsubmit='show()' >
          @csrf
