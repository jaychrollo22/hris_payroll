      ...
      <div class="modal-header">
        ...
        <form method='POST' action='new-overtime' onsubmit="btnOT.disabled = true; return true;"  enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class='col-md-6'>
                  ...
                  <div class="mt-2">
                    ...
                    <input id="start_time" type="hidden" name='start_time' class="form-control">
                    <input id="end_time" type="hidden" name='end_time' class="form-control">
          ...
          <div class="modal-footer">
            ...
            <button id="btnOT" type="submit" name="btnOT" disabled class="btn btn-primary">Save</button>
          </div>
        </form>      
