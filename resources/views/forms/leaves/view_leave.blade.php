                  ...
                  <div class='row'>
                    <div class='col-md-6'>
                      <label class="form-check-label ">
                          ...
                          @else
                              <input type="checkbox" name="withpay" class="form-check-input" disabled value="1">  
                          @endif
                        With Pay
                    </label>
                    </div>
                    <div class='col-md-6'>
                      <label class="form-check-label ">
                        @if($leave->halfday == 1)
                            <input type="checkbox" name="halfday" class="form-check-input" disabled value="1" checked>  
                        @else
                            <input type="checkbox" name="halfday" class="form-check-input" disabled value="1">  
                        @endif
                        Halfday
                    </label>
                      <br>
