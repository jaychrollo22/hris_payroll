      ...
      <div class="modal-body text-right">
        <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class='col-md-4'>
              <input type="date" name='applied_date' value="{{$wfh->applied_date}}" class="form-control" required>
            </div>
            </div>
          <div class="form-group row">
            <div class='align-self-center col-md-2 text-right'>
            ...
            <div class='col-md-4'>
              <input type="time" name='date_from' value="{{$wfh->date_from}}" class="form-control" required>
            </div>
            <div class='align-self-center col-md-2 text-right'>
              Time Out
            </div>
            <div class='col-md-4'>
              <input type="time" name='date_to' value="{{$wfh->date_to}}" class="form-control" required>
            </div>
          </div>
