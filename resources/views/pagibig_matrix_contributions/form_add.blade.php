<div class="modal fade" id="newPagibigMatrixContribution" tabindex="-1" role="dialog" aria-labelledby="newPagibigMatrixContributionLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="newHolidaylabel">Pagibig Matrix Contributions</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form  method='POST' action='new-pagibig-matrix-contribution' onsubmit='show()' >
          @csrf
