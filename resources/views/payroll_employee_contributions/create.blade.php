        ...
        <form action='store-payroll-employee-contribution' method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="sss_reg_ee" name="sss_reg_ee" step="0.01" required>
                </div>

                <!-- SSS MPF EE -->
                <div class="form-group">
                    <label for="sss_mpf_ee">SSS MPF EE (Amount)</label>
                    <input type="number" class="form-control" id="sss_mpf_ee" name="sss_mpf_ee" step="0.01" required>
                </div>

                <!-- PHIC EE -->
                <div class="form-group">
                    <label for="phic_ee">PHIC EE (Amount)</label>
                    <input type="number" class="form-control" id="phic_ee" name="phic_ee" step="0.01" required>
                </div>

                <!-- HDMF EE -->
                <div class="form-group">
                    <label for="hdmf_ee">HDMF EE (Amount)</label>
                    <input type="number" class="form-control" id="hdmf_ee" name="hdmf_ee" step="0.01" required>
                </div>

                <!-- SSS REG ER -->
                <div class="form-group">
                    <label for="sss_reg_er">SSS REG ER (Amount)</label>
                    <input type="number" class="form-control" id="sss_reg_er" name="sss_reg_er" step="0.01" required>
                </div>

                <!-- SSS MPF ER -->
                <div class="form-group">
                    <label for="sss_mpf_er">SSS MPF ER (Amount)</label>
                    <input type="number" class="form-control" id="sss_mpf_er" name="sss_mpf_er" step="0.01" required>
                </div>

                <!-- SSS EC -->
                <div class="form-group">
                    <label for="sss_ec">SSS EC (Amount)</label>
                    <input type="number" class="form-control" id="sss_ec" name="sss_ec" step="0.01" required>
                </div>

                <!-- PHIC ER -->
                <div class="form-group">
                    <label for="phic_er">PHIC ER (Amount)</label>
                    <input type="number" class="form-control" id="phic_er" name="phic_er" step="0.01" required>
                </div>

                <!-- HDMF ER -->
                <div class="form-group">
                    <label for="hdmf_er">HDMF ER (Amount)</label>
                    <input type="number" class="form-control" id="hdmf_er" name="hdmf_er" step="0.01" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="payment_schedule" name="payment_schedule" required>
                        <option value="15th">Every 15th</option>
                        <option value="30th">Every 30th</option>
                    </select>
                </div>
