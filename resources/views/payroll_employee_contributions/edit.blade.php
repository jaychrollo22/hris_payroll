            ...
            <form  method='POST' action='update-payroll-employee-contribution/{{$contribution->id}}' onsubmit='show()' >
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sss_reg_ee" id="sss_reg_ee" value="{{ old('sss_reg_ee', $contribution->sss_reg_ee ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sss_mpf_ee" id="sss_mpf_ee" value="{{ old('sss_mpf_ee', $contribution->sss_mpf_ee ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="phic_ee" id="phic_ee" value="{{ old('phic_ee', $contribution->phic_ee ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="hdmf_ee" id="hdmf_ee" value="{{ old('hdmf_ee', $contribution->hdmf_ee ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sss_reg_er" id="sss_reg_er" value="{{ old('sss_reg_er', $contribution->sss_reg_er ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sss_mpf_er" id="sss_mpf_er" value="{{ old('sss_mpf_er', $contribution->sss_mpf_er ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="sss_ec" id="sss_ec" value="{{ old('sss_ec', $contribution->sss_ec ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="phic_er" id="phic_er" value="{{ old('phic_er', $contribution->phic_er ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="hdmf_er" id="hdmf_er" value="{{ old('hdmf_er', $contribution->hdmf_er ?? '') }}" step="0.01" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="payment_schedule" id="payment_schedule" class="form-control" required>
                            <option value="15th" {{ old('payment_schedule', $contribution->payment_schedule ?? '') == '15th' ? 'selected' : '' }}>Every 15th</option>
                            <option value="30th" {{ old('payment_schedule', $contribution->payment_schedule ?? '') == '30th' ? 'selected' : '' }}>Every 30th</option>
                        </select>
