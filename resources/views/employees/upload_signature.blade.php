<div class="modal fade" id="uploadSignature" tabindex="-1" role="dialog" aria-labelledby="uploadSignaturelabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form  method='POST' action='uploadSignatureHr/{{ $user->id }}' onsubmit='show()' enctype="multipart/form-data">
          @csrf
          <div class="modal-body">
            <div class="row">
              <div class='col-md-12 text-center'>
                <img class='border' id='signature-data' src='{{URL::asset($user->employee->signature)}}' onerror="this.src='{{URL::asset('/images/signature.png')}}';" height='100px;' width='auto;'> 
              </div>
            </div>
            <div class="row mt-3">
              <div class='col-md-12 text-center'>
