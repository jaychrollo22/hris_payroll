<div class="modal fade" id="uploadAvatar" tabindex="-1" role="dialog" aria-labelledby="uploadAvatarLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form  method='POST' action='uploadAvatarHr/{{ $user->id }}' onsubmit='show()' enctype="multipart/form-data">
          @csrf
          <div class="modal-body">
            <div class="row">
              <div class='col-md-12 text-center'>
                <img class="rounded-circle" style='width:170px;height:170px;' id='avatar' src='{{ URL::asset($user->employee->avatar) }}' onerror="this.src='{{URL::asset('/images/no_image.png')}}';">
              </div>
            </div>
            <div class="row mt-3">
              <div class='col-md-12 text-center'>
