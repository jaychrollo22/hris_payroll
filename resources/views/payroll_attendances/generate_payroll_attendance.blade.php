<!-- Modal -->
<div class="modal fade" id="generate_payroll_attendance" tabindex="-1" role="dialog" aria-labelledby="generatePayrollAttendance" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="generatePayrollAttendance">Generate Payroll Attendance</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form method='POST' action='generate-payroll-attendance' onsubmit="btnDtr.disabled = true; return true;"  enctype="multipart/form-data">
            @csrf      
