<!-- Modal -->
<div class="modal fade" id="regEmployee" tabindex="-1" role="dialog" aria-labelledby="regEmployeeData" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="regEmployeeData">New Employee</h5>
