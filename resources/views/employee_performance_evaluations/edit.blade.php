                                    ...
                                    <table class="table-bordered mt-2" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[weights_1]" value="{{$ppr['integrity']['weights_1']}}" min="1" max="100" id="integrity[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[weights_2]" value="{{$ppr['integrity']['weights_2']}}" min="1" max="100" id="integrity[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[weights_3]" value="{{$ppr['integrity']['weights_3']}}" min="1" max="100" id="integrity[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[weights_1]" value="{{$ppr['commitment']['weights_1']}}" min="1" max="100" id="commitment[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[weights_2]" value="{{$ppr['commitment']['weights_2']}}" min="1" max="100" id="commitment[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[weights_3]" value="{{$ppr['commitment']['weights_3']}}" min="1" max="100" id="commitment[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[weights_1]" value="{{$ppr['humility']['weights_1']}}" min="1" max="100" id="humility[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[weights_2]" value="{{$ppr['humility']['weights_2']}}" min="1" max="100" id="humility[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[weights_3]" value="{{$ppr['humility']['weights_3']}}" min="1" max="100" id="humility[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[weights_1]" value="{{$ppr['genuine_concern']['weights_1']}}" min="1" max="100" id="genuine_concern[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[weights_2]" value="{{$ppr['genuine_concern']['weights_2']}}" min="1" max="100" id="genuine_concern[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[weights_3]" value="{{$ppr['genuine_concern']['weights_3']}}" min="1" max="100" id="genuine_concern[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[weights_1]" value="{{$ppr['premium_service']['weights_1']}}" min="1" max="100" id="premium_service[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[weights_2]" value="{{$ppr['premium_service']['weights_2']}}" min="1" max="100" id="premium_service[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[weights_3]" value="{{$ppr['premium_service']['weights_3']}}" min="1" max="100" id="premium_service[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[weights_1]" value="{{$ppr['innovation']['weights_1']}}" min="1" max="100" id="innovation[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[weights_2]" value="{{$ppr['innovation']['weights_2']}}" min="1" max="100" id="innovation[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[weights_3]" value="{{$ppr['innovation']['weights_3']}}" min="1" max="100" id="innovation[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[weights_1]" value="{{$ppr['synergy']['weights_1']}}" min="1" max="100" id="synergy[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[weights_2]" value="{{$ppr['synergy']['weights_2']}}" min="1" max="100" id="synergy[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[weights_3]" value="{{$ppr['synergy']['weights_3']}}" min="1" max="100" id="synergy[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[weights_1]" value="{{$ppr['stewardship']['weights_1']}}" min="1" max="100" id="stewardship[weights_1]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[weights_2]" value="{{$ppr['stewardship']['weights_2']}}" min="1" max="100" id="stewardship[weights_2]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[weights_3]" value="{{$ppr['stewardship']['weights_3']}}" min="1" max="100" id="stewardship[weights_3]" onkeyup="updateSumTotalSummaryofRatingsWeight()"></td>
