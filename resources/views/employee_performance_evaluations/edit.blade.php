                                ...
                                <div class="table-responsive">
                                    <table class="table-bordered" width="100%">
                                        <tr>
                                            ...
                                            <td align="center"> <input type="text" placeholder="Calendar Year" width="100%" class="responsive-input myinput" name="calendar_year" value="{{ $ppr['calendar_year']}}" required>  </td>
