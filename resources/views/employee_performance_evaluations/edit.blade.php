                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_1_metric_1]" value="{{$ppr['customer_focus']['strat_1_metric_1']}}"  id="customer_focus[strat_1_metric_1]" placeholder="Metric" ></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_1_metric_1]" value="{{$ppr['operation_efficiency']['strat_1_metric_1']}}"  id="operation_efficiency[strat_1_metric_1]" placeholder="Metric" ></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_1_metric_1]" value="{{$ppr['people']['strat_1_metric_1']}}"  id="people[strat_1_metric_1]" placeholder="Metric" ></td>
