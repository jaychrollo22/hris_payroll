                                ...
                                <div class="table-responsive">
                                    <table class="table-bordered" width="100%">
                                        <tr>
                                            ...
                                            <td align="center"> <input type="date" class="form-control" name="review_date" value="{{ $ppr['review_date'] ? date('Y-m-d',strtotime($ppr['review_date'])) : "" }}"> </td>
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">111% and above</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_1_objective_1]" value="{{$ppr['financial_perspective']['strat_1_objective_1']}}" id="financial_perspective[strat_1_objective_1]" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_1_metric_1]" value="{{$ppr['financial_perspective']['strat_1_metric_1']}}"  id="financial_perspective[strat_1_metric_1]" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_target_1]" value="{{ isset($ppr['financial_perspective']['strat_1_target_1']) ? $ppr['financial_perspective']['strat_1_target_1'] : ""}}" id="financial_perspective[strat_1_target_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_1_target_start_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_1_target_start_completion_1']) ? $ppr['financial_perspective']['strat_1_target_start_completion_1'] : ""}}" placeholder="Start" id="financial_perspective[strat_1_target_start_completion_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_1_target_end_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_1_target_end_completion_1']) ? $ppr['financial_perspective']['strat_1_target_end_completion_1'] : ""}}" placeholder="End" id="financial_perspective[strat_1_target_end_completion_1]"></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_1_remarks_1]" value="{{ isset($ppr['financial_perspective']['strat_1_remarks_1']) ? $ppr['financial_perspective']['strat_1_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_2_objective_1]" value="{{$ppr['financial_perspective']['strat_2_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_2_metric_1]" value="{{$ppr['financial_perspective']['strat_2_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_target_1]" value="{{ isset($ppr['financial_perspective']['strat_2_target_1']) ? $ppr['financial_perspective']['strat_2_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_2_target_start_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_2_target_start_completion_1']) ? $ppr['financial_perspective']['strat_2_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_2_target_end_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_2_target_end_completion_1']) ? $ppr['financial_perspective']['strat_2_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_2_remarks_1]" value="{{ isset($ppr['financial_perspective']['strat_2_remarks_1']) ? $ppr['financial_perspective']['strat_2_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_3_objective_1]" value="{{$ppr['financial_perspective']['strat_3_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_3_metric_1]" value="{{$ppr['financial_perspective']['strat_3_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_target_1]" value="{{ isset($ppr['financial_perspective']['strat_3_target_1']) ? $ppr['financial_perspective']['strat_3_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="financial_perspective[strat_3_target_start_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_3_target_start_completion_1']) ? $ppr['financial_perspective']['strat_3_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="financial_perspective[strat_3_target_end_completion_1]" value="{{ isset($ppr['financial_perspective']['strat_3_target_end_completion_1']) ? $ppr['financial_perspective']['strat_3_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_3_remarks_1]" value="{{ isset($ppr['financial_perspective']['strat_3_remarks_1']) ? $ppr['financial_perspective']['strat_3_remarks_1'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_1_objective_2]" value="{{$ppr['financial_perspective']['strat_1_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_1_metric_2]" value="{{$ppr['financial_perspective']['strat_1_metric_2']}}" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_target_2]" value="{{ isset($ppr['financial_perspective']['strat_1_target_2']) ? $ppr['financial_perspective']['strat_1_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_1_target_start_completion_2]" value="{{ isset($ppr['financial_perspective']['strat_1_target_start_completion_2']) ? $ppr['financial_perspective']['strat_1_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_1_target_end_completion_2]" value="{{ isset($ppr['financial_perspective']['strat_1_target_end_completion_2']) ? $ppr['financial_perspective']['strat_1_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_1_remarks_2]" value="{{ isset($ppr['financial_perspective']['strat_1_remarks_2']) ? $ppr['financial_perspective']['strat_1_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_2_objective_2]" value="{{$ppr['financial_perspective']['strat_2_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_2_metric_2]" value="{{$ppr['financial_perspective']['strat_2_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_target_2]" value="{{ isset($ppr['financial_perspective']['strat_2_target_2']) ? $ppr['financial_perspective']['strat_2_target_2'] : "" }}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_2_target_start_completion_2]" value="{{isset($ppr['financial_perspective']['strat_2_target_start_completion_2']) ? $ppr['financial_perspective']['strat_2_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="financial_perspective[strat_2_target_end_completion_2]" value="{{ isset($ppr['financial_perspective']['strat_2_target_end_completion_2']) ? $ppr['financial_perspective']['strat_2_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_2_remarks_2]" value="{{ isset($ppr['financial_perspective']['strat_2_remarks_2']) ? $ppr['financial_perspective']['strat_2_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="financial_perspective[strat_3_objective_2]" value="{{$ppr['financial_perspective']['strat_3_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_3_metric_2]" value="{{$ppr['financial_perspective']['strat_3_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_target_2]" value="{{ isset($ppr['financial_perspective']['strat_3_target_2']) ? $ppr['financial_perspective']['strat_3_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="financial_perspective[strat_3_target_start_completion_2]" value="{{ isset($ppr['financial_perspective']['strat_3_target_start_completion_2']) ? $ppr['financial_perspective']['strat_3_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="financial_perspective[strat_3_target_end_completion_2]" value="{{ isset($ppr['financial_perspective']['strat_3_target_end_completion_2']) ? $ppr['financial_perspective']['strat_3_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="financial_perspective[strat_3_remarks_2]" value="{{ isset($ppr['financial_perspective']['strat_3_remarks_2']) ? $ppr['financial_perspective']['strat_3_remarks_2'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_1_objective_1]" value="{{$ppr['customer_focus']['strat_1_objective_1']}}" id="customer_focus[strat_1_objective_1]" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_1_metric_1]" value="{{$ppr['customer_focus']['strat_1_metric_1']}}"  id="customer_focus[strat_1_metric_1]" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_target_1]" value="{{ isset($ppr['customer_focus']['strat_1_target_1']) ? $ppr['customer_focus']['strat_1_target_1'] : ""}}" id="customer_focus[strat_1_target_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_1_target_start_completion_1]" value="{{ isset($ppr['customer_focus']['strat_1_target_start_completion_1']) ? $ppr['customer_focus']['strat_1_target_start_completion_1'] : ""}}" placeholder="Start" id="customer_focus[strat_1_target_start_completion_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_1_target_end_completion_1]" value="{{ isset($ppr['customer_focus']['strat_1_target_end_completion_1']) ? $ppr['customer_focus']['strat_1_target_end_completion_1'] : ""}}" placeholder="End" id="customer_focus[strat_1_target_end_completion_1]"></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_1_remarks_1]" value="{{ isset($ppr['customer_focus']['strat_1_remarks_1']) ? $ppr['customer_focus']['strat_1_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_2_objective_1]" value="{{$ppr['customer_focus']['strat_2_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_2_metric_1]" value="{{$ppr['customer_focus']['strat_2_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_target_1]" value="{{ isset($ppr['customer_focus']['strat_2_target_1']) ? $ppr['customer_focus']['strat_2_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_2_target_start_completion_1]" value="{{ isset($ppr['customer_focus']['strat_2_target_start_completion_1']) ? $ppr['customer_focus']['strat_2_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_2_target_end_completion_1]" value="{{ isset($ppr['customer_focus']['strat_2_target_end_completion_1']) ? $ppr['customer_focus']['strat_2_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_2_remarks_1]" value="{{ isset($ppr['customer_focus']['strat_2_remarks_1']) ? $ppr['customer_focus']['strat_2_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_3_objective_1]" value="{{$ppr['customer_focus']['strat_3_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_3_metric_1]" value="{{$ppr['customer_focus']['strat_3_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_target_1]" value="{{ isset($ppr['customer_focus']['strat_3_target_1']) ? $ppr['customer_focus']['strat_3_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="customer_focus[strat_3_target_start_completion_1]" value="{{ isset($ppr['customer_focus']['strat_3_target_start_completion_1']) ? $ppr['customer_focus']['strat_3_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="customer_focus[strat_3_target_end_completion_1]" value="{{ isset($ppr['customer_focus']['strat_3_target_end_completion_1']) ? $ppr['customer_focus']['strat_3_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_3_remarks_1]" value="{{ isset($ppr['customer_focus']['strat_3_remarks_1']) ? $ppr['customer_focus']['strat_3_remarks_1'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_1_objective_2]" value="{{$ppr['customer_focus']['strat_1_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_1_metric_2]" value="{{$ppr['customer_focus']['strat_1_metric_2']}}" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_target_2]" value="{{ isset($ppr['customer_focus']['strat_1_target_2']) ? $ppr['customer_focus']['strat_1_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_1_target_start_completion_2]" value="{{ isset($ppr['customer_focus']['strat_1_target_start_completion_2']) ? $ppr['customer_focus']['strat_1_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_1_target_end_completion_2]" value="{{ isset($ppr['customer_focus']['strat_1_target_end_completion_2']) ? $ppr['customer_focus']['strat_1_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_1_remarks_2]" value="{{ isset($ppr['customer_focus']['strat_1_remarks_2']) ? $ppr['customer_focus']['strat_1_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_2_objective_2]" value="{{$ppr['customer_focus']['strat_2_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_2_metric_2]" value="{{$ppr['customer_focus']['strat_2_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_target_2]" value="{{ isset($ppr['customer_focus']['strat_2_target_2']) ? $ppr['customer_focus']['strat_2_target_2'] : "" }}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_2_target_start_completion_2]" value="{{isset($ppr['customer_focus']['strat_2_target_start_completion_2']) ? $ppr['customer_focus']['strat_2_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="customer_focus[strat_2_target_end_completion_2]" value="{{ isset($ppr['customer_focus']['strat_2_target_end_completion_2']) ? $ppr['customer_focus']['strat_2_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_2_remarks_2]" value="{{ isset($ppr['customer_focus']['strat_2_remarks_2']) ? $ppr['customer_focus']['strat_2_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_3_objective_2]" value="{{$ppr['customer_focus']['strat_3_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_3_metric_2]" value="{{$ppr['customer_focus']['strat_3_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_target_2]" value="{{ isset($ppr['customer_focus']['strat_3_target_2']) ? $ppr['customer_focus']['strat_3_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="customer_focus[strat_3_target_start_completion_2]" value="{{ isset($ppr['customer_focus']['strat_3_target_start_completion_2']) ? $ppr['customer_focus']['strat_3_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="customer_focus[strat_3_target_end_completion_2]" value="{{ isset($ppr['customer_focus']['strat_3_target_end_completion_2']) ? $ppr['customer_focus']['strat_3_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="customer_focus[strat_3_remarks_2]" value="{{ isset($ppr['customer_focus']['strat_3_remarks_2']) ? $ppr['customer_focus']['strat_3_remarks_2'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_1_objective_1]" value="{{$ppr['operation_efficiency']['strat_1_objective_1']}}" id="operation_efficiency[strat_1_objective_1]" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_1_metric_1]" value="{{$ppr['operation_efficiency']['strat_1_metric_1']}}"  id="operation_efficiency[strat_1_metric_1]" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_target_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_1']) ? $ppr['operation_efficiency']['strat_1_target_1'] : ""}}" id="operation_efficiency[strat_1_target_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_1_target_start_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_start_completion_1']) ? $ppr['operation_efficiency']['strat_1_target_start_completion_1'] : ""}}" placeholder="Start" id="operation_efficiency[strat_1_target_start_completion_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_1_target_end_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_end_completion_1']) ? $ppr['operation_efficiency']['strat_1_target_end_completion_1'] : ""}}" placeholder="End" id="operation_efficiency[strat_1_target_end_completion_1]"></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_1_remarks_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_remarks_1']) ? $ppr['operation_efficiency']['strat_1_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_2_objective_1]" value="{{$ppr['operation_efficiency']['strat_2_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_2_metric_1]" value="{{$ppr['operation_efficiency']['strat_2_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_target_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_target_1']) ? $ppr['operation_efficiency']['strat_2_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_2_target_start_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_target_start_completion_1']) ? $ppr['operation_efficiency']['strat_2_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_2_target_end_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_target_end_completion_1']) ? $ppr['operation_efficiency']['strat_2_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_2_remarks_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_remarks_1']) ? $ppr['operation_efficiency']['strat_2_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_3_objective_1]" value="{{$ppr['operation_efficiency']['strat_3_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_3_metric_1]" value="{{$ppr['operation_efficiency']['strat_3_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_target_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_1']) ? $ppr['operation_efficiency']['strat_3_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="operation_efficiency[strat_3_target_start_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_start_completion_1']) ? $ppr['operation_efficiency']['strat_3_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="operation_efficiency[strat_3_target_end_completion_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_end_completion_1']) ? $ppr['operation_efficiency']['strat_3_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_3_remarks_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_remarks_1']) ? $ppr['operation_efficiency']['strat_3_remarks_1'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="text-center">Objective 2</td>
                                                <td colspan="7"></td>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_1_objective_2]" value="{{$ppr['operation_efficiency']['strat_1_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_1_metric_2]" value="{{$ppr['operation_efficiency']['strat_1_metric_2']}}" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_target_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_2']) ? $ppr['operation_efficiency']['strat_1_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_1_target_start_completion_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_start_completion_2']) ? $ppr['operation_efficiency']['strat_1_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_1_target_end_completion_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_target_end_completion_2']) ? $ppr['operation_efficiency']['strat_1_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_1_remarks_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_remarks_2']) ? $ppr['operation_efficiency']['strat_1_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_2_objective_2]" value="{{$ppr['operation_efficiency']['strat_2_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_2_metric_2]" value="{{$ppr['operation_efficiency']['strat_2_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_target_2]" value="{{ isset($ppr['operation_efficiency']['strat_2_target_2']) ? $ppr['operation_efficiency']['strat_2_target_2'] : "" }}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_2_target_start_completion_2]" value="{{isset($ppr['operation_efficiency']['strat_2_target_start_completion_2']) ? $ppr['operation_efficiency']['strat_2_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="operation_efficiency[strat_2_target_end_completion_2]" value="{{ isset($ppr['operation_efficiency']['strat_2_target_end_completion_2']) ? $ppr['operation_efficiency']['strat_2_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_2_remarks_2]" value="{{ isset($ppr['operation_efficiency']['strat_2_remarks_2']) ? $ppr['operation_efficiency']['strat_2_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_3_objective_2]" value="{{$ppr['operation_efficiency']['strat_3_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_3_metric_2]" value="{{$ppr['operation_efficiency']['strat_3_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_target_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_2']) ? $ppr['operation_efficiency']['strat_3_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="operation_efficiency[strat_3_target_start_completion_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_start_completion_2']) ? $ppr['operation_efficiency']['strat_3_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="operation_efficiency[strat_3_target_end_completion_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_target_end_completion_2']) ? $ppr['operation_efficiency']['strat_3_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="operation_efficiency[strat_3_remarks_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_remarks_2']) ? $ppr['operation_efficiency']['strat_3_remarks_2'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_1_objective_1]" value="{{$ppr['people']['strat_1_objective_1']}}" id="people[strat_1_objective_1]" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_1_metric_1]" value="{{$ppr['people']['strat_1_metric_1']}}"  id="people[strat_1_metric_1]" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_1_target_1]" value="{{ isset($ppr['people']['strat_1_target_1']) ? $ppr['people']['strat_1_target_1'] : ""}}" id="people[strat_1_target_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_1_target_start_completion_1]" value="{{ isset($ppr['people']['strat_1_target_start_completion_1']) ? $ppr['people']['strat_1_target_start_completion_1'] : ""}}" placeholder="Start" id="people[strat_1_target_start_completion_1]"></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_1_target_end_completion_1]" value="{{ isset($ppr['people']['strat_1_target_end_completion_1']) ? $ppr['people']['strat_1_target_end_completion_1'] : ""}}" placeholder="End" id="people[strat_1_target_end_completion_1]"></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_1_remarks_1]" value="{{ isset($ppr['people']['strat_1_remarks_1']) ? $ppr['people']['strat_1_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_2_objective_1]" value="{{$ppr['people']['strat_2_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_2_metric_1]" value="{{$ppr['people']['strat_2_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_2_target_1]" value="{{ isset($ppr['people']['strat_2_target_1']) ? $ppr['people']['strat_2_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_2_target_start_completion_1]" value="{{ isset($ppr['people']['strat_2_target_start_completion_1']) ? $ppr['people']['strat_2_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_2_target_end_completion_1]" value="{{ isset($ppr['people']['strat_2_target_end_completion_1']) ? $ppr['people']['strat_2_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_2_remarks_1]" value="{{ isset($ppr['people']['strat_2_remarks_1']) ? $ppr['people']['strat_2_remarks_1'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_3_objective_1]" value="{{$ppr['people']['strat_3_objective_1']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_3_metric_1]" value="{{$ppr['people']['strat_3_metric_1']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_3_target_1]" value="{{ isset($ppr['people']['strat_3_target_1']) ? $ppr['people']['strat_3_target_1'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="people[strat_3_target_start_completion_1]" value="{{ isset($ppr['people']['strat_3_target_start_completion_1']) ? $ppr['people']['strat_3_target_start_completion_1'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="people[strat_3_target_end_completion_1]" value="{{ isset($ppr['people']['strat_3_target_end_completion_1']) ? $ppr['people']['strat_3_target_end_completion_1'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_3_remarks_1]" value="{{ isset($ppr['people']['strat_3_remarks_1']) ? $ppr['people']['strat_3_remarks_1'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="text-center">Objective 2</td>
                                                <td colspan="7"></td>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_1_objective_2]" value="{{$ppr['people']['strat_1_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_1_metric_2]" value="{{$ppr['people']['strat_1_metric_2']}}" placeholder="Metric" class="myinput" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_1_target_2]" value="{{ isset($ppr['people']['strat_1_target_2']) ? $ppr['people']['strat_1_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_1_target_start_completion_2]" value="{{ isset($ppr['people']['strat_1_target_start_completion_2']) ? $ppr['people']['strat_1_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_1_target_end_completion_2]" value="{{ isset($ppr['people']['strat_1_target_end_completion_2']) ? $ppr['people']['strat_1_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_1_remarks_2]" value="{{ isset($ppr['people']['strat_1_remarks_2']) ? $ppr['people']['strat_1_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 2</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_2_objective_2]" value="{{$ppr['people']['strat_2_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_2_metric_2]" value="{{$ppr['people']['strat_2_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_2_target_2]" value="{{ isset($ppr['people']['strat_2_target_2']) ? $ppr['people']['strat_2_target_2'] : "" }}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_2_target_start_completion_2]" value="{{isset($ppr['people']['strat_2_target_start_completion_2']) ? $ppr['people']['strat_2_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" name="people[strat_2_target_end_completion_2]" value="{{ isset($ppr['people']['strat_2_target_end_completion_2']) ? $ppr['people']['strat_2_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_2_remarks_2]" value="{{ isset($ppr['people']['strat_2_remarks_2']) ? $ppr['people']['strat_2_remarks_2'] : ""}}" id="" width="100%" class="responsive-input myinput" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Strat 3</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_3_objective_2]" value="{{$ppr['people']['strat_3_objective_2']}}" id="" width="100%" class="responsive-input myinput" placeholder="Input Here" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_3_metric_2]" value="{{$ppr['people']['strat_3_metric_2']}}" placeholder="Metric" class="myinput"  ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="number" class="text-align-center" min="1" max="100" name="people[strat_3_target_2]" value="{{ isset($ppr['people']['strat_3_target_2']) ? $ppr['people']['strat_3_target_2'] : ""}}" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="people[strat_3_target_start_completion_2]" value="{{ isset($ppr['people']['strat_3_target_start_completion_2']) ? $ppr['people']['strat_3_target_start_completion_2'] : ""}}" placeholder="Start" ></td>
                                                <td style="text-align: center; width:10px!important;"><input type="date" width="100%" name="people[strat_3_target_end_completion_2]" value="{{ isset($ppr['people']['strat_3_target_end_completion_2']) ? $ppr['people']['strat_3_target_end_completion_2'] : ""}}" placeholder="End" ></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input type="text" name="people[strat_3_remarks_2]" value="{{ isset($ppr['people']['strat_3_remarks_2']) ? $ppr['people']['strat_3_remarks_2'] : ""}}" id="" width="100%"  class="responsive-input myinput" disabled></td>
                                            </tr>
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="text" class="text-align-center" name="bsc_description" width="100%" class="responsive-input myinput" disabled></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input type="text" class="text-align-center" name="competency_description" width="100%" class="responsive-input myinput" disabled></td>
                                        </tr>
                                        <tr>
                                    ...
                                    {{-- <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tr>
                                            <td align="center"><textarea width="100%" class="responsive-input myinput" name="areas_of_strength" cols="30" rows="7" placeholder="Input here" disabled>{{$ppr['areas_of_strength']}}</textarea></td>
                                            <td align="center"><textarea width="100%" class="responsive-input myinput" name="developmental_needs" cols="30" rows="7" placeholder="Input here" disabled>{{$ppr['developmental_needs']}}</textarea></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center"><textarea width="100%" class="responsive-input myinput" name="areas_for_enhancement" cols="30" rows="7" placeholder="Input here" disabled>{{$ppr['areas_for_enhancement']}}</textarea></td>
                                            <td align="center"><textarea width="100%" class="responsive-input myinput" name="training_and_development_plans" cols="30" rows="7" placeholder="Input here" disabled>{{$ppr['training_and_development_plans']}}</textarea></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center" style="background-color: rgb(240, 240, 240)"><strong>RATEE'S COMMENTS</strong></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center"><textarea style="max-width:2000px!important;" class="responsive-input myinput" name="ratees_comments" cols="30" rows="7" placeholder="Input here" disabled>{{$ppr['ratees_comments'] ? $ppr['ratees_comments'] : ""}}</textarea></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><textarea style="max-width:2000px!important;" class="responsive-input myinput" name="summary_ratees_comments_recommendation" cols="30" rows="7" placeholder="Input here" disabled>{{isset($ppr['summary_ratees_comments_recommendation']) ? $ppr['summary_ratees_comments_recommendation'] : ""}}</textarea></td>
                                        </tr>
                                    </table> --}}
