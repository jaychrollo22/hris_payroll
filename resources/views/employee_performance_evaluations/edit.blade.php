                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="customer_focus[strat_1_objective_1]" value="{{$ppr['customer_focus']['strat_1_objective_1']}}" id="customer_focus[strat_1_objective_1]" width="100%" class="responsive-input" placeholder="Input Here" ></td>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="operation_efficiency[strat_1_objective_1]" value="{{$ppr['operation_efficiency']['strat_1_objective_1']}}" id="operation_efficiency[strat_1_objective_1]" width="100%" class="responsive-input" placeholder="Input Here" ></td>
                                            ...
                                            <tr>
                                                <td style="width:200px!important;">Strat 1</td>
                                                <td style="text-align: center; width:300px!important;"><input type="text" name="people[strat_1_objective_1]" value="{{$ppr['people']['strat_1_objective_1']}}" id="people[strat_1_objective_1]" width="100%" class="responsive-input" placeholder="Input Here" ></td>
