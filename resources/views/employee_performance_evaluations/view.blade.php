                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_target_1]" value="{{$ppr['financial_perspective']['strat_1_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_weight_1]" value="{{ isset($ppr['financial_perspective']['strat_1_weight_1']) ? $ppr['financial_perspective']['strat_1_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_1_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_1']) ? $ppr['financial_perspective']['strat_1_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_target_1]" value="{{$ppr['financial_perspective']['strat_2_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_weight_1]" value="{{ isset($ppr['financial_perspective']['strat_2_weight_1']) ? $ppr['financial_perspective']['strat_2_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_2_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_1']) ? $ppr['financial_perspective']['strat_2_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_target_1]" value="{{$ppr['financial_perspective']['strat_3_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_weight_1]" value="{{ isset($ppr['financial_perspective']['strat_3_weight_1']) ? $ppr['financial_perspective']['strat_3_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_3_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_1']) ? $ppr['financial_perspective']['strat_3_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_target_2]" value="{{$ppr['financial_perspective']['strat_1_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_1_weight_2]" value="{{ isset($ppr['financial_perspective']['strat_1_weight_2']) ? $ppr['financial_perspective']['strat_1_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_1_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_2']) ? $ppr['financial_perspective']['strat_1_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_target_2]" value="{{$ppr['financial_perspective']['strat_2_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_2_weight_2]" value="{{ isset($ppr['financial_perspective']['strat_2_weight_2']) ? $ppr['financial_perspective']['strat_2_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_2_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_2']) ? $ppr['financial_perspective']['strat_2_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_target_2]" value="{{$ppr['financial_perspective']['strat_3_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="financial_perspective[strat_3_weight_2]" value="{{ isset($ppr['financial_perspective']['strat_3_weight_2']) ? $ppr['financial_perspective']['strat_3_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_3_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_2']) ? $ppr['financial_perspective']['strat_3_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_target_1]" value="{{$ppr['customer_focus']['strat_1_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_weight_1]" value="{{ isset($ppr['customer_focus']['strat_1_weight_1']) ? $ppr['customer_focus']['strat_1_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_1_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_1']) ? $ppr['customer_focus']['strat_1_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_target_1]" value="{{$ppr['customer_focus']['strat_2_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_weight_1]" value="{{ isset($ppr['customer_focus']['strat_2_weight_1']) ? $ppr['customer_focus']['strat_2_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_2_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_1']) ? $ppr['customer_focus']['strat_2_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_target_1]" value="{{$ppr['customer_focus']['strat_3_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_weight_1]" value="{{ isset($ppr['customer_focus']['strat_3_weight_1']) ? $ppr['customer_focus']['strat_3_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_3_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_1']) ? $ppr['customer_focus']['strat_3_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_target_2]" value="{{$ppr['customer_focus']['strat_1_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_1_weight_2]" value="{{ isset($ppr['customer_focus']['strat_1_weight_2']) ? $ppr['customer_focus']['strat_1_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_1_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_2']) ? $ppr['customer_focus']['strat_1_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_target_2]" value="{{$ppr['customer_focus']['strat_2_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_2_weight_2]" value="{{ isset($ppr['customer_focus']['strat_2_weight_2']) ? $ppr['customer_focus']['strat_2_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_2_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_2']) ? $ppr['customer_focus']['strat_2_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_target_2]" value="{{$ppr['customer_focus']['strat_3_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="customer_focus[strat_3_weight_2]" value="{{ isset($ppr['customer_focus']['strat_3_weight_2']) ? $ppr['customer_focus']['strat_3_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_3_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_2']) ? $ppr['customer_focus']['strat_3_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_target_1]" value="{{$ppr['operation_efficiency']['strat_1_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_weight_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_weight_1']) ? $ppr['operation_efficiency']['strat_1_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_1_review_actual_1]" value="{{ isset($ppr['operation_efficiency']['strat_1_review_actual_1']) ? $ppr['operation_efficiency']['strat_1_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_target_1]" value="{{$ppr['operation_efficiency']['strat_2_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_weight_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_weight_1']) ? $ppr['operation_efficiency']['strat_2_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_2_review_actual_1]" value="{{ isset($ppr['operation_efficiency']['strat_2_review_actual_1']) ? $ppr['operation_efficiency']['strat_2_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_target_1]" value="{{$ppr['operation_efficiency']['strat_3_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_weight_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_weight_1']) ? $ppr['operation_efficiency']['strat_3_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_3_review_actual_1]" value="{{ isset($ppr['operation_efficiency']['strat_3_review_actual_1']) ? $ppr['operation_efficiency']['strat_3_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_target_2]" value="{{$ppr['operation_efficiency']['strat_1_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_1_weight_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_weight_2']) ? $ppr['operation_efficiency']['strat_1_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_1_review_actual_2]" value="{{ isset($ppr['operation_efficiency']['strat_1_review_actual_2']) ? $ppr['operation_efficiency']['strat_1_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_target_2]" value="{{$ppr['operation_efficiency']['strat_2_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_2_weight_2]" value="{{ isset($ppr['operation_efficiency']['strat_2_weight_2']) ? $ppr['operation_efficiency']['strat_2_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_2_review_actual_2]" value="{{ isset($ppr['operation_efficiency']['strat_2_review_actual_2']) ? $ppr['operation_efficiency']['strat_2_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_target_2]" value="{{$ppr['operation_efficiency']['strat_3_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="operation_efficiency[strat_3_weight_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_weight_2']) ? $ppr['operation_efficiency']['strat_3_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="operation_efficiency[strat_3_review_actual_2]" value="{{ isset($ppr['operation_efficiency']['strat_3_review_actual_2']) ? $ppr['operation_efficiency']['strat_3_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_1_target_1]" value="{{$ppr['people']['strat_1_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_1_weight_1]" value="{{ isset($ppr['people']['strat_1_weight_1']) ? $ppr['people']['strat_1_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_1_review_actual_1]" value="{{ isset($ppr['people']['strat_1_review_actual_1']) ? $ppr['people']['strat_1_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_2_target_1]" value="{{$ppr['people']['strat_2_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_2_weight_1]" value="{{ isset($ppr['people']['strat_2_weight_1']) ? $ppr['people']['strat_2_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_2_review_actual_1]" value="{{ isset($ppr['people']['strat_2_review_actual_1']) ? $ppr['people']['strat_2_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_3_target_1]" value="{{$ppr['people']['strat_3_target_1']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_3_weight_1]" value="{{ isset($ppr['people']['strat_3_weight_1']) ? $ppr['people']['strat_3_weight_1'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_3_review_actual_1]" value="{{ isset($ppr['people']['strat_3_review_actual_1']) ? $ppr['people']['strat_3_review_actual_1'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_1_target_2]" value="{{$ppr['people']['strat_1_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_1_weight_2]" value="{{ isset($ppr['people']['strat_1_weight_2']) ? $ppr['people']['strat_1_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_1_review_actual_2]" value="{{ isset($ppr['people']['strat_1_review_actual_2']) ? $ppr['people']['strat_1_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_2_target_2]" value="{{$ppr['people']['strat_2_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_2_weight_2]" value="{{ isset($ppr['people']['strat_2_weight_2']) ? $ppr['people']['strat_2_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_2_review_actual_2]" value="{{ isset($ppr['people']['strat_2_review_actual_2']) ? $ppr['people']['strat_2_review_actual_2'] : ""}}" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_3_target_2]" value="{{$ppr['people']['strat_3_target_2']}}" required></td>
                                                ...
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="100" name="people[strat_3_weight_2]" value="{{ isset($ppr['people']['strat_3_weight_2']) ? $ppr['people']['strat_3_weight_2'] : ""}}" disabled></td>
                                                <td style="text-align: center; width:10px!important;"><input disabled type="number" class="text-align-center" min="1" max="5" name="people[strat_3_review_actual_2]" value="{{ isset($ppr['people']['strat_3_review_actual_2']) ? $ppr['people']['strat_3_review_actual_2'] : ""}}" disabled></td>
                                    ...
                                    <table class="table-bordered mt-2" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[weights_1]" value="{{$ppr['integrity']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[self_rating_1]" value="{{isset($ppr['integrity']['self_rating_1']) ? $ppr['integrity']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[superios_rating_1]" value="{{isset($ppr['integrity']['self_rating_1']) ? $ppr['integrity']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[wtd_score_1]" value="{{isset($ppr['integrity']['self_rating_1']) ? $ppr['integrity']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[weights_2]" value="{{$ppr['integrity']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[self_rating_2]" value="{{isset($ppr['integrity']['self_rating_2']) ? $ppr['integrity']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[superios_rating_2]" value="{{isset($ppr['integrity']['superios_rating_2']) ? $ppr['integrity']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[wtd_score_2]" value="{{isset($ppr['integrity']['wtd_score_2']) ? $ppr['integrity']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[weights_3]" value="{{$ppr['integrity']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[self_rating_3]" value="{{isset($ppr['integrity']['self_rating_3']) ? $ppr['integrity']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[superios_rating_3]" value="{{isset($ppr['integrity']['superios_rating_3']) ? $ppr['integrity']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="integrity[wtd_score_3]" value="{{isset($ppr['integrity']['wtd_score_3']) ? $ppr['integrity']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[weights_1]" value="{{$ppr['commitment']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[self_rating_1]" value="{{isset($ppr['commitment']['self_rating_1']) ? $ppr['commitment']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[superios_rating_1]" value="{{isset($ppr['commitment']['self_rating_1']) ? $ppr['commitment']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[wtd_score_1]" value="{{isset($ppr['commitment']['self_rating_1']) ? $ppr['commitment']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[weights_2]" value="{{$ppr['commitment']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[self_rating_2]" value="{{isset($ppr['commitment']['self_rating_2']) ? $ppr['commitment']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[superios_rating_2]" value="{{isset($ppr['commitment']['superios_rating_2']) ? $ppr['commitment']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[wtd_score_2]" value="{{isset($ppr['commitment']['wtd_score_2']) ? $ppr['commitment']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[weights_3]" value="{{$ppr['commitment']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[self_rating_3]" value="{{isset($ppr['commitment']['self_rating_3']) ? $ppr['commitment']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[superios_rating_3]" value="{{isset($ppr['commitment']['superios_rating_3']) ? $ppr['commitment']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="commitment[wtd_score_3]" value="{{isset($ppr['commitment']['wtd_score_3']) ? $ppr['commitment']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[weights_1]" value="{{$ppr['humility']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[self_rating_1]" value="{{isset($ppr['humility']['self_rating_1']) ? $ppr['humility']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[superios_rating_1]" value="{{isset($ppr['humility']['self_rating_1']) ? $ppr['humility']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[wtd_score_1]" value="{{isset($ppr['humility']['self_rating_1']) ? $ppr['humility']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[weights_2]" value="{{$ppr['humility']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[self_rating_2]" value="{{isset($ppr['humility']['self_rating_2']) ? $ppr['humility']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[superios_rating_2]" value="{{isset($ppr['humility']['superios_rating_2']) ? $ppr['humility']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[wtd_score_2]" value="{{isset($ppr['humility']['wtd_score_2']) ? $ppr['humility']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[weights_3]" value="{{$ppr['humility']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[self_rating_3]" value="{{isset($ppr['humility']['self_rating_3']) ? $ppr['humility']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[superios_rating_3]" value="{{isset($ppr['humility']['superios_rating_3']) ? $ppr['humility']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="humility[wtd_score_3]" value="{{isset($ppr['humility']['wtd_score_3']) ? $ppr['humility']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[weights_1]" value="{{$ppr['genuine_concern']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[self_rating_1]" value="{{isset($ppr['genuine_concern']['self_rating_1']) ? $ppr['genuine_concern']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[superios_rating_1]" value="{{isset($ppr['genuine_concern']['self_rating_1']) ? $ppr['genuine_concern']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[wtd_score_1]" value="{{isset($ppr['genuine_concern']['self_rating_1']) ? $ppr['genuine_concern']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[weights_2]" value="{{$ppr['genuine_concern']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[self_rating_2]" value="{{isset($ppr['genuine_concern']['self_rating_2']) ? $ppr['genuine_concern']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[superios_rating_2]" value="{{isset($ppr['genuine_concern']['superios_rating_2']) ? $ppr['genuine_concern']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[wtd_score_2]" value="{{isset($ppr['genuine_concern']['wtd_score_2']) ? $ppr['genuine_concern']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[weights_3]" value="{{$ppr['genuine_concern']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[self_rating_3]" value="{{isset($ppr['genuine_concern']['self_rating_3']) ? $ppr['genuine_concern']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[superios_rating_3]" value="{{isset($ppr['genuine_concern']['superios_rating_3']) ? $ppr['genuine_concern']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="genuine_concern[wtd_score_3]" value="{{isset($ppr['genuine_concern']['wtd_score_3']) ? $ppr['genuine_concern']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[weights_1]" value="{{$ppr['premium_service']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[self_rating_1]" value="{{isset($ppr['premium_service']['self_rating_1']) ? $ppr['premium_service']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[superios_rating_1]" value="{{isset($ppr['premium_service']['self_rating_1']) ? $ppr['premium_service']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[wtd_score_1]" value="{{isset($ppr['premium_service']['self_rating_1']) ? $ppr['premium_service']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[weights_2]" value="{{$ppr['premium_service']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[self_rating_2]" value="{{isset($ppr['premium_service']['self_rating_2']) ? $ppr['premium_service']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[superios_rating_2]" value="{{isset($ppr['premium_service']['superios_rating_2']) ? $ppr['premium_service']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[wtd_score_2]" value="{{isset($ppr['premium_service']['wtd_score_2']) ? $ppr['premium_service']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[weights_3]" value="{{$ppr['premium_service']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[self_rating_3]" value="{{isset($ppr['premium_service']['self_rating_3']) ? $ppr['premium_service']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[superios_rating_3]" value="{{isset($ppr['premium_service']['superios_rating_3']) ? $ppr['premium_service']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="premium_service[wtd_score_3]" value="{{isset($ppr['premium_service']['wtd_score_3']) ? $ppr['premium_service']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[weights_1]" value="{{$ppr['innovation']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[self_rating_1]" value="{{isset($ppr['innovation']['self_rating_1']) ? $ppr['innovation']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[superios_rating_1]" value="{{isset($ppr['innovation']['self_rating_1']) ? $ppr['innovation']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[wtd_score_1]" value="{{isset($ppr['innovation']['self_rating_1']) ? $ppr['innovation']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[weights_2]" value="{{$ppr['innovation']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[self_rating_2]" value="{{isset($ppr['innovation']['self_rating_2']) ? $ppr['innovation']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[superios_rating_2]" value="{{isset($ppr['innovation']['superios_rating_2']) ? $ppr['innovation']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[wtd_score_2]" value="{{isset($ppr['innovation']['wtd_score_2']) ? $ppr['innovation']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[weights_3]" value="{{$ppr['innovation']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[self_rating_3]" value="{{isset($ppr['innovation']['self_rating_3']) ? $ppr['innovation']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[superios_rating_3]" value="{{isset($ppr['innovation']['superios_rating_3']) ? $ppr['innovation']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="innovation[wtd_score_3]" value="{{isset($ppr['innovation']['wtd_score_3']) ? $ppr['innovation']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[weights_1]" value="{{$ppr['synergy']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[self_rating_1]" value="{{isset($ppr['synergy']['self_rating_1']) ? $ppr['synergy']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[superios_rating_1]" value="{{isset($ppr['synergy']['self_rating_1']) ? $ppr['synergy']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[wtd_score_1]" value="{{isset($ppr['synergy']['self_rating_1']) ? $ppr['synergy']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[weights_2]" value="{{$ppr['synergy']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[self_rating_2]" value="{{isset($ppr['synergy']['self_rating_2']) ? $ppr['synergy']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[superios_rating_2]" value="{{isset($ppr['synergy']['superios_rating_2']) ? $ppr['synergy']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[wtd_score_2]" value="{{isset($ppr['synergy']['wtd_score_2']) ? $ppr['synergy']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[weights_3]" value="{{$ppr['synergy']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[self_rating_3]" value="{{isset($ppr['synergy']['self_rating_3']) ? $ppr['synergy']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[superios_rating_3]" value="{{isset($ppr['synergy']['superios_rating_3']) ? $ppr['synergy']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="synergy[wtd_score_3]" value="{{isset($ppr['synergy']['wtd_score_3']) ? $ppr['synergy']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[weights_1]" value="{{$ppr['stewardship']['weights_1']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[self_rating_1]" value="{{isset($ppr['stewardship']['self_rating_1']) ? $ppr['stewardship']['self_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[superios_rating_1]" value="{{isset($ppr['stewardship']['self_rating_1']) ? $ppr['stewardship']['superios_rating_1'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[wtd_score_1]" value="{{isset($ppr['stewardship']['self_rating_1']) ? $ppr['stewardship']['wtd_score_1'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[weights_2]" value="{{$ppr['stewardship']['weights_2']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[self_rating_2]" value="{{isset($ppr['stewardship']['self_rating_2']) ? $ppr['stewardship']['self_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[superios_rating_2]" value="{{isset($ppr['stewardship']['superios_rating_2']) ? $ppr['stewardship']['superios_rating_2'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[wtd_score_2]" value="{{isset($ppr['stewardship']['wtd_score_2']) ? $ppr['stewardship']['wtd_score_2'] : ""}}" min="1"  max="5" disabled></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[weights_3]" value="{{$ppr['stewardship']['weights_3']}}" min="1" max="100" required></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[self_rating_3]" value="{{isset($ppr['stewardship']['self_rating_3']) ? $ppr['stewardship']['self_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[superios_rating_3]" value="{{isset($ppr['stewardship']['superios_rating_3']) ? $ppr['stewardship']['superios_rating_3'] : ""}}" min="1" max="5" disabled></td>
                                                <td class="text-center text-dark"><input disabled type="number" class="text-align-center" name="stewardship[wtd_score_3]" value="{{isset($ppr['stewardship']['wtd_score_3']) ? $ppr['stewardship']['wtd_score_3'] : ""}}" min="1" max="5" disabled></td>
                                            </tr>
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="bsc_weight" value="{{$ppr['bsc_weight']}}"></td>
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="bsc_actual_score" value="{{$ppr['bsc_actual_score']}}" disabled></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="competency_weight" value="{{$ppr['competency_weight']}}"></td>
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="competency_actual_score" value="{{$ppr['competency_actual_score']}}" disabled></td>
                                            <td align="center"><input disabled type="text" name="competency_description" width="100%" class="responsive-input" disabled></td>
                                        </tr>
                                        <tr>
                                            <td align="center">TOTAL</td>
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="total_weight" value="{{$ppr['total_weight']}}" disabled></td>
                                            <td align="center"><input disabled type="number" class="text-align-center" min="1" max="100" name="total_actual_score" value="{{$ppr['total_actual_score']}}" disabled></td>
                                            <td align="center"></td>
                                        </tr>
                                    </table>
