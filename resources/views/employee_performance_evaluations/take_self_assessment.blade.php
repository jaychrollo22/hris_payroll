                                ...
                                <div class="table-responsive">
                                    <table class="table-bordered" width="100%">
                                        <tr>
                                            ...
                                            <td align="center"> 
                                                <select class='form-control form-control-sm ' name='calendar_year'>
                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center text-dark" colspan="2" style="background-color:rgb(240, 240, 240)">
                                                    <h4>Actual</h4>
                                                </th>
                                                <th class="text-center text-dark" style="background-color:rgb(240, 240, 240)">
                                                    <h4>Remarks</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_1_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_1']) ? $ppr['financial_perspective']['strat_1_review_actual_1'] : ""}}" id="financial_perspective[strat_1_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_1_review_actual_1_actual_grade]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_1_actual_grade']) ? $ppr['financial_perspective']['strat_1_review_actual_1_actual_grade'] : ""}}" id="financial_perspective[strat_1_review_actual_1_actual_grade]" readonly>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_2_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_1']) ? $ppr['financial_perspective']['strat_2_review_actual_1'] : ""}}" id="financial_perspective[strat_2_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_3_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_1']) ? $ppr['financial_perspective']['strat_3_review_actual_1'] : ""}}" id="financial_perspective[strat_3_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_1_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_2']) ? $ppr['financial_perspective']['strat_1_review_actual_2'] : ""}}" id="financial_perspective[strat_1_review_actual_2]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_2_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_2']) ? $ppr['financial_perspective']['strat_2_review_actual_2'] : ""}}" id="financial_perspective[strat_2_review_actual_2]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="financial_perspective[strat_3_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_2']) ? $ppr['financial_perspective']['strat_3_review_actual_2'] : ""}}" id="financial_perspective[strat_3_review_actual_2]" onkeyup="computeActualGradeFinancialPerspective()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_1_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_1']) ? $ppr['customer_focus']['strat_1_review_actual_1'] : ""}}" id="customer_focus[strat_1_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_2_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_1']) ? $ppr['customer_focus']['strat_2_review_actual_1'] : ""}}" id="customer_focus[strat_2_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_3_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_1']) ? $ppr['customer_focus']['strat_3_review_actual_1'] : ""}}" id="customer_focus[strat_3_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_1_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_2']) ? $ppr['customer_focus']['strat_1_review_actual_2'] : ""}}" id="customer_focus[strat_1_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_2_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_2']) ? $ppr['customer_focus']['strat_2_review_actual_2'] : ""}}" id="customer_focus[strat_2_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="customer_focus[strat_3_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_2']) ? $ppr['customer_focus']['strat_3_review_actual_2'] : ""}}" id="customer_focus[strat_3_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_1_review_actual_1]" value="{{ isset($ppr['people']['strat_1_review_actual_1']) ? $ppr['people']['strat_1_review_actual_1'] : ""}}" id="people[strat_1_review_actual_1]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_2_review_actual_1]" value="{{ isset($ppr['people']['strat_2_review_actual_1']) ? $ppr['people']['strat_2_review_actual_1'] : ""}}" id="people[strat_2_review_actual_1]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_3_review_actual_1]" value="{{ isset($ppr['people']['strat_3_review_actual_1']) ? $ppr['people']['strat_3_review_actual_1'] : ""}}" id="people[strat_3_review_actual_1]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_1_review_actual_2]" value="{{ isset($ppr['people']['strat_1_review_actual_2']) ? $ppr['people']['strat_1_review_actual_2'] : ""}}" id="people[strat_1_review_actual_2]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_2_review_actual_2]" value="{{ isset($ppr['people']['strat_2_review_actual_2']) ? $ppr['people']['strat_2_review_actual_2'] : ""}}" id="people[strat_2_review_actual_2]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" name="people[strat_3_review_actual_2]" value="{{ isset($ppr['people']['strat_3_review_actual_2']) ? $ppr['people']['strat_3_review_actual_2'] : ""}}" id="people[strat_3_review_actual_2]" onkeyup="computeActualGradePeople()">
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                    ...
                                    <table class="table-bordered mt-2" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[self_rating_1]" id="integrity[self_rating_1]" value="{{isset($ppr['integrity']['self_rating_1']) ? $ppr['integrity']['self_rating_1'] : ""}}"  min="1" max="4" onkeyup="computeWTDScore()"></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[superios_rating_1]" id="integrity[superios_rating_1]" value="{{isset($ppr['integrity']['self_rating_1']) ? $ppr['integrity']['superios_rating_1'] : ""}}"  min="1" max="4" readonly></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[self_rating_3]" id="integrity[self_rating_3]" value="{{isset($ppr['integrity']['self_rating_3']) ? $ppr['integrity']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_1]" id="commitment[self_rating_1]" value="{{isset($ppr['commitment']['self_rating_1']) ? $ppr['commitment']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_2]" id="commitment[self_rating_2]" value="{{isset($ppr['commitment']['self_rating_2']) ? $ppr['commitment']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_3]" id="commitment[self_rating_3]" value="{{isset($ppr['commitment']['self_rating_3']) ? $ppr['commitment']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_1]" id="humility[self_rating_1]" value="{{isset($ppr['humility']['self_rating_1']) ? $ppr['humility']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_2]" id="humility[self_rating_2]" value="{{isset($ppr['humility']['self_rating_2']) ? $ppr['humility']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_3]" id="humility[self_rating_3]" value="{{isset($ppr['humility']['self_rating_3']) ? $ppr['humility']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_1]" id="genuine_concern[self_rating_1]" value="{{isset($ppr['genuine_concern']['self_rating_1']) ? $ppr['genuine_concern']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_2]" id="genuine_concern[self_rating_2]" value="{{isset($ppr['genuine_concern']['self_rating_2']) ? $ppr['genuine_concern']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_3]" id="genuine_concern[self_rating_3]" value="{{isset($ppr['genuine_concern']['self_rating_3']) ? $ppr['genuine_concern']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_1]" id="premium_service[self_rating_1]" value="{{isset($ppr['premium_service']['self_rating_1']) ? $ppr['premium_service']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_2]" id="premium_service[self_rating_2]" value="{{isset($ppr['premium_service']['self_rating_2']) ? $ppr['premium_service']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_3]" id="premium_service[self_rating_3]" value="{{isset($ppr['premium_service']['self_rating_3']) ? $ppr['premium_service']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_1]" id="innovation[self_rating_1]" value="{{isset($ppr['innovation']['self_rating_1']) ? $ppr['innovation']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_2]" id="innovation[self_rating_2]" value="{{isset($ppr['innovation']['self_rating_2']) ? $ppr['innovation']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_3]" id="innovation[self_rating_3]" value="{{isset($ppr['innovation']['self_rating_3']) ? $ppr['innovation']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_1]" id="synergy[self_rating_1]" value="{{isset($ppr['synergy']['self_rating_1']) ? $ppr['synergy']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_2]" id="synergy[self_rating_2]" value="{{isset($ppr['synergy']['self_rating_2']) ? $ppr['synergy']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_3]" id="synergy[self_rating_3]" value="{{isset($ppr['synergy']['self_rating_3']) ? $ppr['synergy']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_1]" id="stewardship[self_rating_1]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_1'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_2]" id="stewardship[self_rating_2]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_2'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_3]" id="stewardship[self_rating_3]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_3'] : ""}}" min="1" max="4" onkeyup="computeWTDScore()"></td>
