                                    ...
                                    <table class="table-bordered mt-1" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_1_self_rating_1]" value="{{ isset($ppr['financial_perspective']['strat_1_self_rating_1']) ? $ppr['financial_perspective']['strat_1_self_rating_1'] : ""}}" id="financial_perspective[strat_1_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_1_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_1']) ? $ppr['financial_perspective']['strat_1_review_actual_1'] : ""}}" id="financial_perspective[strat_1_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    ...
                                                    @if($ppr['financial_perspective']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_2_self_rating_1]" value="{{ isset($ppr['financial_perspective']['strat_2_self_rating_1']) ? $ppr['financial_perspective']['strat_2_self_rating_1'] : ""}}" id="financial_perspective[strat_2_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_2_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_1']) ? $ppr['financial_perspective']['strat_2_review_actual_1'] : ""}}" id="financial_perspective[strat_2_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_3_self_rating_1]" value="{{ isset($ppr['financial_perspective']['strat_3_self_rating_1']) ? $ppr['financial_perspective']['strat_3_self_rating_1'] : ""}}" id="financial_perspective[strat_3_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_3_review_actual_1]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_1']) ? $ppr['financial_perspective']['strat_3_review_actual_1'] : ""}}" id="financial_perspective[strat_3_review_actual_1]" onkeyup="computeActualGradeFinancialPerspective()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_1_self_rating_2]" value="{{ isset($ppr['financial_perspective']['strat_1_self_rating_2']) ? $ppr['financial_perspective']['strat_1_self_rating_2'] : ""}}" id="financial_perspective[strat_1_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_1_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_1_review_actual_2']) ? $ppr['financial_perspective']['strat_1_review_actual_2'] : ""}}" id="financial_perspective[strat_1_review_actual_2]" onkeyup="computeActualGradeFinancialPerspective()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_2_self_rating_2]" value="{{ isset($ppr['financial_perspective']['strat_2_self_rating_2']) ? $ppr['financial_perspective']['strat_2_self_rating_2'] : ""}}" id="financial_perspective[strat_2_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_2_review_actual_2]" value="{{ isset($ppr['financial_perspective']['strat_2_review_actual_2']) ? $ppr['financial_perspective']['strat_2_review_actual_2'] : ""}}" id="financial_perspective[strat_2_review_actual_2]" onkeyup="computeActualGradeFinancialPerspective()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_3_self_rating_2]" value="{{ isset($ppr['financial_perspective']['strat_3_self_rating_2']) ? $ppr['financial_perspective']['strat_3_self_rating_2'] : ""}}" id="financial_perspective[strat_3_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="financial_perspective[strat_3_review_actual_2_actual_grade]" value="{{ isset($ppr['financial_perspective']['strat_3_review_actual_2_actual_grade']) ? $ppr['financial_perspective']['strat_3_review_actual_2_actual_grade'] : ""}}" id="financial_perspective[strat_3_review_actual_2_actual_grade]" readonly>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['financial_perspective']['strat_3_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_1_self_rating_1]" value="{{ isset($ppr['customer_focus']['strat_1_self_rating_1']) ? $ppr['customer_focus']['strat_1_self_rating_1'] : ""}}" id="customer_focus[strat_1_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_1_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_1']) ? $ppr['customer_focus']['strat_1_review_actual_1'] : ""}}" id="customer_focus[strat_1_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_2_self_rating_1]" value="{{ isset($ppr['customer_focus']['strat_2_self_rating_1']) ? $ppr['customer_focus']['strat_2_self_rating_1'] : ""}}" id="customer_focus[strat_2_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_2_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_1']) ? $ppr['customer_focus']['strat_2_review_actual_1'] : ""}}" id="customer_focus[strat_2_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_3_self_rating_1]" value="{{ isset($ppr['customer_focus']['strat_3_self_rating_1']) ? $ppr['customer_focus']['strat_3_self_rating_1'] : ""}}" id="customer_focus[strat_3_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_3_review_actual_1]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_1']) ? $ppr['customer_focus']['strat_3_review_actual_1'] : ""}}" id="customer_focus[strat_3_review_actual_1]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_1_self_rating_2]" value="{{ isset($ppr['customer_focus']['strat_1_self_rating_2']) ? $ppr['customer_focus']['strat_1_self_rating_2'] : ""}}" id="customer_focus[strat_1_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_1_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_1_review_actual_2']) ? $ppr['customer_focus']['strat_1_review_actual_2'] : ""}}" id="customer_focus[strat_1_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                        @if($ppr['customer_focus']['strat_2_objective_2'])
                                                            <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_2_self_rating_2]" value="{{ isset($ppr['customer_focus']['strat_2_self_rating_2']) ? $ppr['customer_focus']['strat_2_self_rating_2'] : ""}}" id="customer_focus[strat_2_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                        @endif
                                                    </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_2_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_2_review_actual_2']) ? $ppr['customer_focus']['strat_2_review_actual_2'] : ""}}" id="customer_focus[strat_2_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_3_self_rating_2]" value="{{ isset($ppr['customer_focus']['strat_3_self_rating_2']) ? $ppr['customer_focus']['strat_3_self_rating_2'] : ""}}" id="customer_focus[strat_3_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="customer_focus[strat_3_review_actual_2]" value="{{ isset($ppr['customer_focus']['strat_3_review_actual_2']) ? $ppr['customer_focus']['strat_3_review_actual_2'] : ""}}" id="customer_focus[strat_3_review_actual_2]" onkeyup="computeActualGradeCustomerFocus()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['customer_focus']['strat_3_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['operation_efficiency']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="operation_efficiency[strat_3_review_actual_2_actual_grade]" value="{{ isset($ppr['operation_efficiency']['strat_3_review_actual_2_actual_grade']) ? $ppr['operation_efficiency']['strat_3_review_actual_2_actual_grade'] : ""}}" id="operation_efficiency[strat_3_review_actual_2_actual_grade]" readonly>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['operation_efficiency']['strat_3_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_1_self_rating_1]" value="{{ isset($ppr['people']['strat_1_self_rating_1']) ? $ppr['people']['strat_1_self_rating_1'] : ""}}" id="people[strat_1_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_1_review_actual_1]" value="{{ isset($ppr['people']['strat_1_review_actual_1']) ? $ppr['people']['strat_1_review_actual_1'] : ""}}" id="people[strat_1_review_actual_1]" onkeyup="computeActualGradePeople()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    ...
                                                    @if($ppr['people']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_2_self_rating_1]" value="{{ isset($ppr['people']['strat_2_self_rating_1']) ? $ppr['people']['strat_2_self_rating_1'] : ""}}" id="people[strat_2_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_2_review_actual_1]" value="{{ isset($ppr['people']['strat_2_review_actual_1']) ? $ppr['people']['strat_2_review_actual_1'] : ""}}" id="people[strat_2_review_actual_1]" onkeyup="computeActualGradePeople()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_3_self_rating_1]" value="{{ isset($ppr['people']['strat_3_self_rating_1']) ? $ppr['people']['strat_3_self_rating_1'] : ""}}" id="people[strat_3_self_rating_1]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_1'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_3_review_actual_1]" value="{{ isset($ppr['people']['strat_3_review_actual_1']) ? $ppr['people']['strat_3_review_actual_1'] : ""}}" id="people[strat_3_review_actual_1]" onkeyup="computeActualGradePeople()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_1'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_1_self_rating_2]" value="{{ isset($ppr['people']['strat_1_self_rating_2']) ? $ppr['people']['strat_1_self_rating_2'] : ""}}" id="people[strat_1_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>

                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_1_review_actual_2]" value="{{ isset($ppr['people']['strat_1_review_actual_2']) ? $ppr['people']['strat_1_review_actual_2'] : ""}}" id="people[strat_1_review_actual_2]" onkeyup="computeActualGradePeople()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_1_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_2_self_rating_2]" value="{{ isset($ppr['people']['strat_2_self_rating_2']) ? $ppr['people']['strat_2_self_rating_2'] : ""}}" id="people[strat_2_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_2_review_actual_2]" value="{{ isset($ppr['people']['strat_2_review_actual_2']) ? $ppr['people']['strat_2_review_actual_2'] : ""}}" id="people[strat_2_review_actual_2]" onkeyup="computeActualGradePeople()" @if($enable_edit_approver  == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_2_objective_2'])
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_3_self_rating_2]" value="{{ isset($ppr['people']['strat_3_self_rating_2']) ? $ppr['people']['strat_3_self_rating_2'] : ""}}" id="people[strat_3_self_rating_2]" onkeyup="updateSumTotalSummaryofSelfRatingsWeightScore()" @if($enable_edit == false) readonly @endif>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                                ...
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                                        <input type="number" class="text-align-center" min="1" max="5" step="1" onkeypress="validateInputBsc(event)" maxlength="1" name="people[strat_3_review_actual_2_actual_grade]" value="{{ isset($ppr['people']['strat_3_review_actual_2_actual_grade']) ? $ppr['people']['strat_3_review_actual_2_actual_grade'] : ""}}" id="people[strat_3_review_actual_2_actual_grade]" readonly>
                                                    @endif
                                                </td>
                                                <td style="text-align: center; width:10px!important;">
                                                    @if($ppr['people']['strat_3_objective_2'])
                                    ...
                                    <table class="table-bordered mt-2" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[self_rating_1]" id="integrity[self_rating_1]" value="{{isset($ppr['integrity']) ? $ppr['integrity']['self_rating_1'] : ""}}"  min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[self_rating_2]" id="integrity[self_rating_2]" value="{{isset($ppr['integrity']) ? $ppr['integrity']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[superios_rating_2]" id="integrity[superios_rating_2]" value="{{isset($ppr['integrity']['superios_rating_2']) ? $ppr['integrity']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[self_rating_3]" id="integrity[self_rating_3]" value="{{isset($ppr['integrity']) ? $ppr['integrity']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="integrity[superios_rating_3]" id="integrity[superios_rating_3]" value="{{isset($ppr['integrity']) ? $ppr['integrity']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_1]" id="commitment[self_rating_1]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[superios_rating_1]" id="commitment[superios_rating_1]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_2]" id="commitment[self_rating_2]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[superios_rating_2]" id="commitment[superios_rating_2]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[self_rating_3]" id="commitment[self_rating_3]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="commitment[superios_rating_3]" id="commitment[superios_rating_3]" value="{{isset($ppr['commitment']) ? $ppr['commitment']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_1]" id="humility[self_rating_1]" value="{{isset($ppr['humility']) ? $ppr['humility']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[superios_rating_1]" id="humility[superios_rating_1]" value="{{isset($ppr['humility']) ? $ppr['humility']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_2]" id="humility[self_rating_2]" value="{{isset($ppr['humility']) ? $ppr['humility']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[superios_rating_2]" id="humility[superios_rating_2]" value="{{isset($ppr['humility']) ? $ppr['humility']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[self_rating_3]" id="humility[self_rating_3]" value="{{isset($ppr['humility']) ? $ppr['humility']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="humility[superios_rating_3]" id="humility[superios_rating_3]" value="{{isset($ppr['humility']) ? $ppr['humility']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_1]" id="genuine_concern[self_rating_1]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[superios_rating_1]" id="genuine_concern[superios_rating_1]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_2]" id="genuine_concern[self_rating_2]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[superios_rating_2]" id="genuine_concern[superios_rating_2]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[self_rating_3]" id="genuine_concern[self_rating_3]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="genuine_concern[superios_rating_3]" id="genuine_concern[superios_rating_3]" value="{{isset($ppr['genuine_concern']) ? $ppr['genuine_concern']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_1]" id="premium_service[self_rating_1]" value="{{isset($ppr['premium_service']) ? $ppr['premium_service']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[superios_rating_1]" id="premium_service[superios_rating_1]" value="{{isset($ppr['premium_service']) ? $ppr['premium_service']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_2]" id="premium_service[self_rating_2]" value="{{isset($ppr['premium_service']) ? $ppr['premium_service']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[superios_rating_2]" id="premium_service[superios_rating_2]" value="{{isset($ppr['premium_service']) ? $ppr['premium_service']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[self_rating_3]" id="premium_service[self_rating_3]" value="{{isset($ppr['premium_service']['self_rating_3']) ? $ppr['premium_service']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="premium_service[superios_rating_3]" id="premium_service[superios_rating_3]" value="{{isset($ppr['premium_service']['superios_rating_3']) ? $ppr['premium_service']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_1]" id="innovation[self_rating_1]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[superios_rating_1]" id="innovation[superios_rating_1]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_2]" id="innovation[self_rating_2]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[superios_rating_2]" id="innovation[superios_rating_2]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[self_rating_3]" id="innovation[self_rating_3]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="innovation[superios_rating_3]" id="innovation[superios_rating_3]" value="{{isset($ppr['innovation']) ? $ppr['innovation']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_1]" id="synergy[self_rating_1]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[superios_rating_1]" id="synergy[superios_rating_1]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['superios_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_2]" id="synergy[self_rating_2]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[superios_rating_2]" id="synergy[superios_rating_2]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['superios_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[self_rating_3]" id="synergy[self_rating_3]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="synergy[superios_rating_3]" id="synergy[superios_rating_3]" value="{{isset($ppr['synergy']) ? $ppr['synergy']['superios_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeActualRatingCompetency()" @if($enable_edit_approver  == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_1]" id="stewardship[self_rating_1]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_1'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_2]" id="stewardship[self_rating_2]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_2'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-dark">0.42</td>
                                                <td class="text-center text-dark"><input type="number" class="text-align-center" name="stewardship[self_rating_3]" id="stewardship[self_rating_3]" value="{{isset($ppr['stewardship']) ? $ppr['stewardship']['self_rating_3'] : ""}}" min="1" max="4" step="1" onkeypress="validateInputCompetency(event)" maxlength="1" onkeyup="computeSelfRatingCompetency()" @if($enable_edit == false) readonly @endif></td>
...
@section('empAllowScript')
	<script>
        ...
        function validateInputBsc(event) {
        ...
        function validateInputCompetency(event) {
            var char = String.fromCharCode(event.which);
            if (!/[1-4]/.test(char)) {
                event.preventDefault();
            }
