          ...
          <div class="modal-body">
            <div class="row">
              <div class='col-md-12 text-center'>
                <img id='avatar' src='@if($settings->where('icon','!=',null)->first()){{URL::asset($settings->where('icon','!=',null)->orderyBy('id','desc')->first()->icon)}}@endif' onerror="this.src='{{URL::asset('/images/icon.png')}}';" id='icon'  class=" circle-border m-b-md border" alt="profile" height='130px;' width='130px;'> <br>
